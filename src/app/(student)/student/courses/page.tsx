          ...
          {filtered.map(course => {
            ...
            return (
              <div key={course.id} className="bg-white border border-gray-200 rounded-xl p-5 flex flex-col hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-gray-500 line-clamp-2 flex-1 mb-3">{course.description}</p>
                {enrolled && (
                  <div className="mb-3">
                ...
                {enrolled ? (
                  <Link href={`/student/courses/${course.id}/study`} className="block text-center text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg py-2 transition-colors">
